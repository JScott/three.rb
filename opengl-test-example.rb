...
verticesA = vertex2[3]
verticesB = vertex2[3]
verticesA[0].x, verticesA[0].y = -0.90, -0.90
verticesA[1].x, verticesA[1].y = 0.85, -0.90
verticesA[2].x, verticesA[2].y = -0.90, 0.85
verticesB[0].x, verticesB[0].y = 0.90, -0.85
verticesB[1].x, verticesB[1].y = 0.90, 0.90
verticesB[2].x, verticesB[2].y = -0.85, 0.90
